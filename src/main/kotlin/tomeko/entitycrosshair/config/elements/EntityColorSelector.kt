...
class EntityColorSelector : BasicElement(64, 32, false) {
    ...
    override fun draw(vg: Long, x: Float, y: Float, inputHandler: InputHandler) {
        ...
        var color = EntityCrosshairConfig.entityCanvaConfig.penColor
        ...
        EntityCrosshairConfig.entityCanvaConfig.penColor = color
    }
